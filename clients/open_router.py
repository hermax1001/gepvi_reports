...
2. СТАТИСТИКА С ЦЕЛЯМИ (КОМПАКТНЫЙ ФОРМАТ - каждый показатель в одну строку):
   ...
   После всех показателей - ОДИН общий комментарий (2-3 предложения) по выполнению целей с учетом цели пользователя (похудеть/набрать/поддержать вес)
