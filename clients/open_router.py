...
- ОБЯЗАТЕЛЬНО разделяй текст пустыми строками (\n\n) - НЕ делай сплошной текст!
...
- Используй МНОГО пустых строк (\n\n) между разделами - НЕ делай текст сплошняком
...
- ОБЯЗАТЕЛЬНО разделяй текст пустыми строками (\n\n) между разделами - НЕ делай сплошной текст!
- Используй эмодзи для нутриентов (🔥💪🥑🍞🌾💧) и разрешенные эмоциональные эмодзи
